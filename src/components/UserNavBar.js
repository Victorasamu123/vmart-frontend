  ...
  return (
    <>
     ...
     <div className='nav-search-input-div'>
        ...
        <button className='btn btn-info ms-2  bbb'><img src={icon11} alt="" width={20} /></button>
        <div class="ps-5 ms-5 pt-1 help">
                ...
                <div class="dropdown ps-2 fs-5">
                    ...
                    <ul class="dropdown-menu">
                        <li><Link to="/signin" class="dropdown-item" ><button class="btn btn-info w-75 ms-3">Help</button></Link></li>
