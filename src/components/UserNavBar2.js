  ...
  return (
    <>
      ...
      <div id='sideNavBar'>
          ...
          <div>
            <ul>
              <li className='mb-2'><Link to="/signin" className='link-sidenav-li mb-3'>Home</Link></li>
              <li className='mb-2'><Link to="/signin" className='link-sidenav-li mb-3'>Categories</Link>
              <ul>
              <li className='mb-2'><Link to="/signin" className='link-sidenav-li mb-3'>phones</Link></li>
              <li className='mb-2'><Link to="/signin" className='link-sidenav-li mb-3'>computers</Link></li>
              <li className='mb-2'><Link to="/signin" className='link-sidenav-li mb-3'>electronics</Link></li>
              <li className='mb-2'><Link to="/signin" className='link-sidenav-li mb-3'>gaming</Link></li>
              </ul>
              </li>
              <li className='mb-2'><Link to="/signin" className='link-sidenav-li mb-3'>Cart</Link></li>
              <li className='mb-2'><Link to="/signin" className='link-sidenav-li mb-3'>Account</Link></li>
              <li className='mb-2'><Link to="/signin" className='link-sidenav-li mb-3'>Transaction History</Link></li>
    ...
    <Link to="/signin" className='btn btn-light signup-btn-landing' style={{textDecoration:"none",color:"black"}}>Signin</Link>
    <Link to="/signup" className='btn btn-light signin-btn-landing' style={{textDecoration:"none",color:"black"}}>Signup</Link>
      </div>
    </>
  )
}
